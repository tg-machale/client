...
@connect(({ accountAndsettings, user }) => ({
...
class BaseView extends Component {
  ...
  handlerSubmit = event => {
    ...
    const { updateStatus } = this.props.accountAndsettings
    form.validateFields((err, values) => {
      if (!err) {
        ...
        if (updateStatus.payload.code === 0) {
          message.error(updateStatus.payload.msg);
        } else if (updateStatus.payload.code === 1) {
          message.success(updateStatus.payload.msg);
        }
        // message.success(
        //   formatMessage({
