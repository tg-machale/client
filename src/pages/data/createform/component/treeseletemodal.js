...
class NormaltreeseleteForm extends PureComponent {
  state = {
    visible: false,
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
        <Form onSubmit={this.handleSubmit} className="treeselete-form" labelCol={{ span: 5 }} wrapperCol={{ span: 12 }}>
...
const treeseletemodal = Form.create({ name: 'treeselete-form' })(NormaltreeseleteForm);
export default treeseletemodal
